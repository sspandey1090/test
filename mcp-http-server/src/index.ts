...
server.tool(
  "http_post",
  "Perform an HTTP POST request to a URL with a JSON body",
  {
...
server.tool(
  "http_put",
  "Perform an HTTP PUT request to a URL with a JSON body",
  {
...
server.tool(
  "http_delete",
  "Perform an HTTP DELETE request to a URL",
  {
...
server.tool(
  "fetch_json",
  "Fetch JSON data from a URL and return it parsed and formatted",
  {
